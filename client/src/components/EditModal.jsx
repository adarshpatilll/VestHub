      ...
      <AnimatePresence>
         <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm">
            ...
            <motion.div
               ...
               className="bg-dark text-light hide-scrollbar relative max-h-[80vh] w-[90%] overflow-y-auto rounded-xl p-4 sm:w-[90%] sm:rounded-2xl sm:p-6 md:w-full md:max-w-3xl"
            >
               {/* Close button */}
               <button
                  onClick={onClose}
                  className="hover:text-light absolute top-3 right-3 text-neutral-400 sm:top-4 sm:right-4"
               >
                  <X size={22} />
               </button>
               ...
               <button
                  ...
                  disabled={loading}
                  className={`mt-6 w-full rounded-lg bg-yellow-600 p-3 font-medium hover:bg-yellow-700 ${
