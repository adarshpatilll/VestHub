...
const Footer = () => {
   ...
   return (
      <motion.footer
         ...
         className={`bg-dark text-light fixed right-0 bottom-0 left-0 z-40 flex h-16 w-full items-center justify-between gap-2 border-t border-t-neutral-600 px-2 text-sm sm:flex md:hidden ${isIOSPWA ? "h-[5.2rem] pb-5" : ""}`}
      >
         {/* links */}
